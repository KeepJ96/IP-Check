		...
		if (sender.hasPermission("ipcheck.toggle") || sender.isOp()) {
			if (args.length == 2) {
				...
				if (args[1].equalsIgnoreCase("login-notify") || args[1].equalsIgnoreCase("notification") || args[1].equalsIgnoreCase("notify")) {
					...
					if (response == 0) {
						sender.sendMessage(ChatColor.GOLD + TranslationManager.PLUG_NAME + ChatColor.YELLOW + TranslationManager.TOGGLE_NOTIFY + ChatColor.RED + "False");
					} else if (response == 1) {
						sender.sendMessage(ChatColor.GOLD + TranslationManager.PLUG_NAME + ChatColor.YELLOW + TranslationManager.TOGGLE_NOTIFY + ChatColor.GREEN + "True");
					} else {
						sender.sendMessage(ChatColor.GOLD + TranslationManager.PLUG_NAME + ChatColor.RED + TranslationManager.TOGGLE_ERR);
					}
					...
					if (response == 0) {
						sender.sendMessage(ChatColor.GOLD + TranslationManager.PLUG_NAME + ChatColor.YELLOW + TranslationManager.TOGGLE_DETAIL + ChatColor.RED + "False");
					} else if (response == 1) {
						sender.sendMessage(ChatColor.GOLD + TranslationManager.PLUG_NAME + ChatColor.YELLOW + TranslationManager.TOGGLE_DETAIL + ChatColor.GREEN + "True");
					} else {
						sender.sendMessage(ChatColor.GOLD + TranslationManager.PLUG_NAME + ChatColor.RED + TranslationManager.TOGGLE_ERR);
					}
					...
					if (response == 0) {
						sender.sendMessage(ChatColor.GOLD + TranslationManager.PLUG_NAME + ChatColor.YELLOW + TranslationManager.TOGGLE_SECURE + ChatColor.RED + "False");
					} else if (response == 1) {
						sender.sendMessage(ChatColor.GOLD + TranslationManager.PLUG_NAME + ChatColor.YELLOW + TranslationManager.TOGGLE_SECURE + ChatColor.GREEN + "True");
					} else {
						sender.sendMessage(ChatColor.GOLD + TranslationManager.PLUG_NAME + ChatColor.RED + TranslationManager.TOGGLE_ERR);
					}
					...
					sender.sendMessage(ChatColor.GOLD + TranslationManager.PLUG_NAME + ChatColor.YELLOW + "List of Toggle Options:");
					...
					sender.sendMessage(TranslationManager.ILL_ARGS_ERR);
				}
			} else {
